...
| **minLexicsPercent** | Минимальный процент правильных ответов по лексике (словарному запасу). | `70` |
| **minListeningPercent** | Минимальный процент по аудированию (восприятие речи на слух). | `60` |
