package com.otus.otuskotlin.skillGrader.mappers.v1

import com.otus.otuskotlin.skillGrader.mappers.v1.exceptions.UnknownRequestClass
...
private fun String?.toRuleId() = this?.let { AppRuleId(it) } ?: AppRuleId.NONE
private fun String?.toRuleLock() = this?.let { AppRuleLock(it) } ?: AppRuleLock.NONE
...
private fun RuleSearchFilter?.toInternal(): AppRuleFilter = AppRuleFilter(
    searchString = this?.searchString ?: ""
)

private fun RuleCreateObject.toInternal(): AppRule = AppRule(
    name = name ?: "",
...
private fun RuleUpdateObject.toInternal(): AppRule = AppRule(
    id = id.toRuleId(),
    name = name ?: "",
    grade = grade.fromTransport(),
    minGrammarPercent = minGrammarPercent ?: 0,
