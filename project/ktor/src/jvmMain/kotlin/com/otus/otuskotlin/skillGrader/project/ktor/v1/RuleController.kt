...
suspend fun ApplicationCall.createRule(appSettings: ServerSettings) =
...
suspend fun ApplicationCall.readRule(appSettings: ServerSettings) =
...
suspend fun ApplicationCall.updateRule(appSettings: ServerSettings) =
...
suspend fun ApplicationCall.deleteRule(appSettings: ServerSettings) =
...
suspend fun ApplicationCall.searchRule(appSettings: ServerSettings) =
